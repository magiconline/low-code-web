    ...
    children = props.children.map((child, index) => {
      return typeof child === 'string' ? child
        : <div className="canvas-field">
          <PreviewComponent key={index} {...child} pageInfo={pageInfo} setPageInfo={setPageInfo} selectComponent={selectComponent} setSelectComponent={setSelectComponent}></PreviewComponent>
        </div>
    })
  }
...
export { Component, PreviewComponent }